...
const menuGroups = {
	general: [{ icon: LayoutDashboard, label: "Dashboard", href: "/dashboard" }],
	learning: [{ icon: ClipboardList, label: "Data Table", href: "/dashboard/learning-fatigue-data" }],
	account: [
